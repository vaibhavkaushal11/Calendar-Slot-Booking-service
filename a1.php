...
function build_calendar($month, $year) {
    ...
    $calendar.= "<a class='btn btn-xs btn-danger' href='?month=".date('m', mktime(0, 0, 0, $month+1, 1, $year))."&year=".date('Y', mktime(0, 0, 0, $month+1, 1, $year))."'>Next Month</a></center><br>";
     ...
     while ($currentDay <= $numberDays) {
          ...
          $date = "$year-$month-$currentDayRel";
            ...
            {
                $calendar.="<td><h4>$currentDay</h4> <button class='btn btn-classic btn-xs'>Weekend</button>";
            }
...
if($totalbookings==6)
{
     $calendar.="<td class='$today'><h4>$currentDay</h4> <a href='#' class='btn btn-danger btn-xs'>All Slots Booked!</a>";
}
else
{
